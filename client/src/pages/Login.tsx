  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      ...
      <Card className="w-full max-w-md relative z-10 animate-fade-in-up">
        ...
        {/* Google Sign-In */}
        <a
          href="https://coursenotifier.studenthub.dedyn.io/api/auth/google"
          className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-xl border-2 border-zinc-700 bg-white hover:bg-gray-50 text-gray-700 font-medium transition-all duration-200"
        >
